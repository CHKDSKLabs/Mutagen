...
#
# Reads .mutagen/state/tool-calls/{slice_id}.jsonl (written by
...
STATE_FILE=".mutagen/state/active-slice.json"
...
LOG_FILE=".mutagen/state/tool-calls/${SAFE_SLICE_ID}.jsonl"
